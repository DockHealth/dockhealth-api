...
// @deprecated
test('DEPRECATED Get Webhooks', async () => {
...
// @deprecated
test('DEPRECATED Authorize Webhook', async () => {
  let id = null
  let headers = null
  let tunnel = null
  let err = null
  ...
  try {
    ...
    await deprecatedDeleteWebhook(id, headers)
...
// @deprecated
const deprecatedDeleteWebhook = async (id, headers) => {
  if (id) {
    await request
